...
TEST(ShortestPathTestSuite, GridNotRectangleTest){
    ...
    pair<int, string> resp = sp.dijkstra(notRect, placeHolder, placeHolder);
...
TEST(ShortestPathTestSuite, GridRectangleTest){
    ...
    pair<int, string> resp = sp.dijkstra(cGrid, placeHolder, placeHolder);
...
TEST(ShortestPathTestSuite, NegativeWeightTest){
    ...
    pair<int, string> resp = sp.dijkstra(cGrid, start, end);
...
TEST(ShortestPathTestSuite, nullStartEndDefaultsToZerosTest) {
    ...
    pair<int, string> resp = sp.dijkstra(cGrid, nullCoord, notNull);
    vector<pair<int,int>> r = sp.getRoute();
    pair<int, int> startPoint = r[0];

    pair<int, string> resp2 = sp.dijkstra(cGrid, notNull, nullCoord);
